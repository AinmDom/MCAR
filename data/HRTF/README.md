...
| `sonicom_measured_ffcmp_minphase_44k1/` | [SONICOM 官方完整数据集](https://transfer.ic.ac.uk:9090/#/2022_SONICOM-HRTF-DATASET/) | 由下载器根据官方元数据冻结的350名干净测量被试；每人一个保留 ITD 的 44.1 kHz 自由场补偿 SOFA | 预计 872.82 MiB |
...
当前冻结快照为372条元数据、350名干净测量被试。下载器只获取
...
manifests/clean_subjects.csv         350名正式队列及来源 URL
