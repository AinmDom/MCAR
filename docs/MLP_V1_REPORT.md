...
- [12 人对侧 HRTF 总览](../residual_learning/reconstruction/mlp_n03_v1/figures/test12_contralateral_hrtf_overview.png)
- [12 人指标总览](../residual_learning/reconstruction/mlp_n03_v1/figures/test12_metric_overview.png)
- [pp33 重建对比](../residual_learning/reconstruction/mlp_n03_v1/figures/pp33_reconstruction_comparison.png)
- [pp81 重建对比](../residual_learning/reconstruction/mlp_n03_v1/figures/pp81_reconstruction_comparison.png)
...
| 文件 | 作用 |
|---|---|
| `residual_learning/matlab/export_hutubs_residual_dataset.m` | residual HDF5 导出 |
| `residual_learning/python/validate_residual_hdf5.py` | HDF5 完整性检查 |
| `residual_learning/python/compute_training_statistics.py` | train-only 统计 |
| `residual_learning/python/residual_data.py` | block sampler 和特征构造 |
| `residual_learning/python/residual_model.py` | ResidualMLP |
| `residual_learning/python/train_residual_mlp.py` | v1 训练 |
| `residual_learning/python/evaluate_residual_mlp.py` | 完整 residual 评价 |
| `residual_learning/matlab/prepare_test_reconstruction_inputs.m` | 测试 complex cache |
| `residual_learning/python/predict_reconstructed_residuals.py` | GPU residual 推理 |
| `residual_learning/matlab/evaluate_test_reconstruction.m` | 回填、指标与绘图 |

### 16.2 轻量结果

- [训练历史](../residual_learning/runs/mlp_n03_v1/history.csv)
- [Validation residual 指标](../residual_learning/runs/mlp_n03_v1/val_metrics.json)
- [Test residual 指标](../residual_learning/runs/mlp_n03_v1/test_metrics.json)
- [严格指标汇总](../residual_learning/reconstruction/mlp_n03_v1/aggregate_metrics.csv)
- [逐被试指标](../residual_learning/reconstruction/mlp_n03_v1/per_subject_metrics.csv)
- [ERB 明细](../residual_learning/reconstruction/mlp_n03_v1/erb_summary.csv)
- [对侧高频明细](../residual_learning/reconstruction/mlp_n03_v1/contralateral_high_frequency_summary.csv)
- [ILD 明细](../residual_learning/reconstruction/mlp_n03_v1/ild_summary.csv)
- [重建质量](../residual_learning/reconstruction/mlp_n03_v1/reconstruction_quality.csv)
