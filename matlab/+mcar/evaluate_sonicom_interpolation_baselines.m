function evaluate_sonicom_interpolation_baselines(subjectLimit, outputName, ...
        publishResults, splitName, mcarPredictionName, allowTest, ...
        fspPredictionName)
%EVALUATE_SONICOM_INTERPOLATION_BASELINES SONICOM Q26 horizontal baselines.
%
% Evaluates six established methods, plus optional FSP-AE predictions, with
% the same frozen SONICOM split and strict
...
for subjectIndex = 1:subjectCount
    ...
    spectra = {cat(3, shOnly.HRTF_L, shOnly.HRTF_R), ...
        cat(3, supdeqSh.HRTF_L, supdeqSh.HRTF_R), ...
        nnSpectra, barySpectra, mcaSpectra, mcarSpectra};
    ...
    for methodIndex = 1:numel(methodIds)
        if methodIds(methodIndex) == "FSPAE"
            ...
            [selectedMagnitudeDb, hrir] = method_representation( ...
                spectra{methodIndex}, selectedIndices, 256);
        end
    ...
    qualityChecks = [qualityChecks; table(subjectLabel, ...
        ...
        nnParityError, baryParityError, fspFrequencyError, ...
