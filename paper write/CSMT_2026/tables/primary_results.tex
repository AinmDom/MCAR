...
\bicaption[tab:primary-results]{表}{Q26外部方法与Hybrid主要指标（44名测试被试，767个插值方向）}{Tab.}{Primary metrics with Q26 (44 test subjects, 767 interpolation directions)}
\begin{tabular}{lrrrr}
\toprule
...
FSP-AE & $1.1845 \pm 0.3492$ & $1.9089 \pm 0.7008$ & $\mathbf{3.1644} \pm 0.6854$ & $\mathbf{0.7587} \pm 1.0397$ \\
RANF & $1.0632 \pm 0.1264$ & $1.5573 \pm 0.1636$ & $3.4697 \pm 0.2538$ & $0.7755 \pm 0.1888$ \\
Hybrid & $\mathbf{0.8175} \pm 0.3427$ & $\mathbf{1.2004} \pm 0.0952$ & $3.4549 \pm 0.2575$ & $0.7794 \pm 0.8389$ \\
\bottomrule
\end{tabular}
\par\smallskip
\parbox{\linewidth}{\footnotesize 数值为被试均值$\pm$样本标准差。加粗仅表示本表八方法中该列最低均值，不表示对其他方法的显著优势。SUpDEq Bary.为重心插值；Hybrid采用E190三个末点成员。}
\end{table}
