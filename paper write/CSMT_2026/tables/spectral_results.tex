...
\bicaption[tab:spectral-results]{表}{外部方法与Hybrid的局部频谱及频带ILD（44名测试被试，Q26）}{Tab.}{Supplementary local-spectral and band-ILD comparison (44 test subjects, Q26)}
\begin{tabular}{lrrrr}
\toprule
...
Hybrid & \textbf{0.3997} & \textbf{0.2146} & \textbf{0.4877} & \textbf{1.6205} \\
\bottomrule
\end{tabular}
\par\smallskip
\parbox{\linewidth}{\footnotesize 均为被试均值，加粗仅表示本表八方法中的最低均值。高频差分与凹口深度使用767个插值方向，频带ILD使用72个水平面插值方向；本表为补充描述，不提升为独立确认性证据。}
\end{table}
