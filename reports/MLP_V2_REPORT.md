...
- [12 人对侧 HRTF 总览](../results/residual_mlp/mlp_n03_v2/evaluation/figures/test12_contralateral_hrtf_overview.png)
- [12 人指标总览](../results/residual_mlp/mlp_n03_v2/evaluation/figures/test12_metric_overview.png)
- [v1/v2 聚合指标对比](../results/residual_mlp/mlp_n03_v2/evaluation/figures/v1_v2_aggregate_comparison.png)
- [pp33 重建对比](../results/residual_mlp/mlp_n03_v2/evaluation/figures/pp33_reconstruction_comparison.png)
- [pp81 重建对比](../results/residual_mlp/mlp_n03_v2/evaluation/figures/pp81_reconstruction_comparison.png)
...
| 文件 | 作用 |
|---|---|
| `src/mcar/models/residual_mlp.py` | v1/v2 共用网络 |
| `src/mcar/data.py` | `BinauralSpectrumSampler` 与特征构造 |
| `src/mcar/training/train_mlp_v2.py` | v2 复合损失训练 |
| `src/mcar/evaluation/evaluate_residual_mlp.py` | 完整 residual MAE/RMSE |
| `src/mcar/evaluation/predict_reconstructed_residuals.py` | 测试方向 residual 推理 |
| `matlab/+mcar/evaluate_test_reconstruction.m` | 回填、严格指标和绘图 |
| `matlab/+mcar/plot_v1_v2_reconstruction_comparison.m` | v1/v2 聚合对比图 |

### 14.2 保留结果

- [训练历史](../results/residual_mlp/mlp_n03_v2/training/history.csv)
- [训练报告](../results/residual_mlp/mlp_n03_v2/training/training_report.json)
- [Validation 完整 residual 指标](../results/residual_mlp/mlp_n03_v2/training/val_metrics.json)
- [Test 完整 residual 指标](../results/residual_mlp/mlp_n03_v2/training/test_metrics.json)
- [严格指标汇总](../results/residual_mlp/mlp_n03_v2/evaluation/aggregate_metrics.csv)
- [逐被试严格指标](../results/residual_mlp/mlp_n03_v2/evaluation/per_subject_metrics.csv)
- [v1/v2 对比表](../results/residual_mlp/mlp_n03_v2/evaluation/v1_v2_comparison.csv)
