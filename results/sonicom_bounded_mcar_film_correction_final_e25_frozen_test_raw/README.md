...
- MCAR prediction: `sonicom_bounded_mcar_film_correction_final_e25_ensemble_test`
- RANF prediction: `sonicom_ranf_q26_final_test`
- FSP-AE prediction: `sonicom_fsp_ae_q26_locked_final_test`
...
| MCAR v3.2 | 0.794 +/- 0.240 | 1.202 +/- 0.114 | 3.477 +/- 0.279 | 0.674 +/- 0.488 |
