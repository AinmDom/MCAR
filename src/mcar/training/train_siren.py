...
def main() -> None:
    ...
    if configuration.get("experiment_type") != "single_subject_siren_baseline":
        raise ValueError("This entry point only accepts a single-subject baseline config")
